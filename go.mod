...
require (
	...
	github.com/opiproject/opi-smbios-bridge v0.1.3-0.20230821065508-aea63511c938
	github.com/opiproject/opi-spdk-bridge v0.1.2-0.20230819062743-325cfd95e0e8
