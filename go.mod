...
require (
	...
	github.com/opiproject/opi-smbios-bridge v0.1.3-0.20230831144815-edd547d7363a
	github.com/opiproject/opi-spdk-bridge v0.1.2-0.20230902064820-27ee6cd14d35
