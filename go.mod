...
require (
	...
	github.com/opiproject/opi-smbios-bridge v0.1.3-0.20230708040512-9629c6975261
	github.com/opiproject/opi-spdk-bridge v0.1.2-0.20230708123919-f78377f8bfef
