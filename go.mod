...
require (
	...
	github.com/opiproject/opi-smbios-bridge v0.1.3-0.20230715041832-f751cc6bc477
	github.com/opiproject/opi-spdk-bridge v0.1.2-0.20230715121009-09c0f6ef925d
