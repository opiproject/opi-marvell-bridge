...
require (
	...
	github.com/opiproject/opi-smbios-bridge v0.1.3-0.20230626143614-f214b085cb62
	github.com/opiproject/opi-spdk-bridge v0.1.2-0.20230701170401-529538c61df8
